		...
		<main>
			<div className="space-y-8">
				...
				<div>
					...
					<p>Project Architect for various projects from Pre-schematic Design through Construction Administration</p>
				</div>
				...
				<div>
					...
					<p>Design and BIM Project Coordinator for multiple DSA K-12 educational projects from Pre-schematic Design through Construction Documents</p>
				</div>
				...
				<div>
					...
					<p>Project Manager and BIM Project Manager for multiple DSA K–12 educational projects from Pre-schematic Design through Construction Documents</p>
				</div>

				<div>
					<p className="mb-2">11.2010—03.2014</p>
					<p className="mb-1 font-medium">spf: architects Studio Pali Fekete</p>
					<p className="mb-1">Job Captain 09.2013 - 03.2014</p>
					<p className="mb-1">Intermediate Designer 11.2010 - 08.2013</p>
					<p>Job Captain for high end residential and multi-family projects from Schematic Design through Construction Administration</p>
				</div>
				...
				<div>
					...
					<p>Junior Designer for multiple civic project from Schematic Design through Construction Documents</p>
				</div>
				...
				<div>
					...
					<p>Internship Designer for multiple commercial projects from Schematic Design through Design Development</p>
				</div>
			</div>
		</main>
	);
